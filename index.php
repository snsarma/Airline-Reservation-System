		...
		<script type = "text/javascript">
			...
			<!--
				...
				function validation()
				{
					...
					|| email.value.length == 0 || password.value.length == 0 || cfrm_password.value.length == 0
					|| ssn.value.length == 0 || area_code.value.length == 0 || second_part.value.length == 0
...
//-->
		...
		<div id = "page_content">
			...
			<div name = 'center' style = "background: white; width:815px; height:800px;background-image: url(http://localhost/Website/Resources/Images/home_page_background.png) ">
				
				
				<table style = "position:absolute; margin-top:480px; margin-left : 50px"
				cellspacing = "15px">
			   ...
			   <tr> <td> <label id = 'label'> Confirm </label> </td><td> <input type = "password" id = 'cfrm_password' class = 'input'  style = 'border-radius:5px;'/> </td></tr>
			 
			</table>
			
			<table style = "position:absolute; margin-top:480px; margin-left : 420px" cellspacing = "15px">
				<tr>
...
for($year = 1940; $year <= 2012; $year++)
{
  ...
  <td> <input type = "text" id = "ssn" style = 'border-radius:5px;' maxlength = "15"/> </td>
			...
			position: absolute; margin-top: 670px; margin-left: 435px;">
			</div>

<div style = "position:absolute; margin-top:710px; margin-left : 650px">
<input type = "submit" value = "   Create Acount   " style = "float:right;margin-top:10%;" onclick = "validation()" />
</div>
